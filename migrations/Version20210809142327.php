 ...
 */
final class Version20210809142327 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__media_object AS SELECT id, file_path FROM media_object');
        $this->addSql('DROP TABLE media_object');
        $this->addSql('CREATE TABLE media_object (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, file_path VARCHAR(255) DEFAULT NULL COLLATE BINARY, mime_type VARCHAR(255) DEFAULT \'\' NOT NULL)');
        $this->addSql('INSERT INTO media_object (id, file_path) SELECT id, file_path FROM __temp__media_object');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__media_object AS SELECT id, file_path FROM media_object');
        $this->addSql('DROP TABLE media_object');
        $this->addSql('CREATE TABLE media_object (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, file_path VARCHAR(255) DEFAULT NULL, is_image BOOLEAN DEFAULT \'0\' NOT NULL)');
        $this->addSql('INSERT INTO media_object (id, file_path) SELECT id, file_path FROM __temp__media_object');
        $this->addSql('DROP TABLE __temp__media_object');
    }
}

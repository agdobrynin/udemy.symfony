 ...
 */
final class Version20210802144612 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD COLUMN roles CLOB NOT NULL DEFAULT '.User::ROLE_USER);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_9474526CF675F31B ON comment (author_id)');
        $this->addSql('CREATE INDEX IDX_9474526C4B89032C ON comment (post_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, login, password, email, name FROM user');
        ...
        $this->addSql('INSERT INTO user (id, login, password, email, name) SELECT id, login, password, email, name FROM __temp__user');
